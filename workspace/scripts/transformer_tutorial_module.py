# class & functions from tensorflow transformer tutorial
# original code: https://github.com/tensorflow/docs-l10n/blob/master/site/ja/tutorials/text/transformer.ipynb
import numpy as np
